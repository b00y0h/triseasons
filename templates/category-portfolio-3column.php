...
<script>  
	   ...
	   $j('.portfolio3 li:nth-child(3n)').addClass("last");
...
<div class="grid12 first">
  ...
  <ul class="portfolio3 gallery">
    ...
    <li  class="column3">
      <p>
        <?php						
			...
			if ( !empty( $video ) ) {
				...
				the_post_thumbnail( 'column3-img', array('class' => 'img-border1') ); 
				echo '</a>';
			}
			}else{
      ...
      <a href="<?php the_permalink() ?>" class="view-more-small">View More </a> <div class="clear space-divider">&nbsp;</div>  </li>
