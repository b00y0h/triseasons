...
<script>  
	   ...
	   $j('.portfolio2-img-left li:nth-child(2n)').addClass("last");
...
<div class="grid12 first">
  ...
  <ul class="portfolio2-img-left gallery">
    ...
    <li  class="column2 last">
      <h3>
        <?php the_title(); ?>
      </h3>
      <?php   the_content_rss('', TRUE, '',100); ?>
      <a href="<?php the_permalink() ?>" class="view-more-small">View More </a> <div class="clear space-divider">&nbsp;</div><div class="clear space-divider">&nbsp;</div> </li>
    <?php endwhile; ?>
  </ul>
  <div class="clear">&nbsp;</div>
