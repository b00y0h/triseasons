...
<script>  
	   ...
	   $j('.portfolio2-img-right li:nth-child(2n)').addClass("last");
...
<div class="grid12 first">
  ...
  <ul class="portfolio2-img-right gallery">
    ...
    <li  class="column2">       
      ...
      <br />
    <a href="<?php the_permalink() ?>" class="view-more-small">View More </a> <div class="clear space-divider">&nbsp;</div><div class="clear space-divider">&nbsp;</div>
